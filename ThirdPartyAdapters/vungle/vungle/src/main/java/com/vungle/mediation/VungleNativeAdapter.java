...
public class VungleNativeAdapter extends UnifiedNativeAdMapper implements BaseAdListener {
    ...
    public void render() {
        ...
        vungleNativeAd = new VungleNativeAd(
                context,
                placementId,
                adConfig,
                        ...
                        new VungleInitializer.VungleInitializationListener() {
                            ...
                            public void onInitializeSuccess() {
                                if (adMarkup != null && !adMarkup.isEmpty()) {
                                    vungleNativeAd.loadNativeAd(adMarkup);
                                    return;
                                }
                                vungleNativeAd.loadNativeAd(null);
                            }
