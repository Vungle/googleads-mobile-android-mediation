...
/**
 * A helper class used to wrap Vungle Banner and MREC in this one class and do the real work to
 * load and display ads.
 */
class VungleBannerRequest {

  private static final String TAG = VungleBannerRequest.class.getSimpleName();
        ...
        .initialize(
            ...
            new VungleInitializer.VungleInitializationListener() {
              ...
              public void onInitializeError(String errorMessage) {
                Log.d(TAG, "SDK init failed: " + VungleBannerRequest.this);
   ...
   * VungleBannerRequest#destroy(View)}.
   */
  void destroy() {
  ...
  private LoadAdCallback mAdLoadCallback =
      new LoadAdCallback() {
        ...
        public void onError(String id, VungleException exception) {
          Log.d(TAG, "Ad load failed:" + VungleBannerRequest.this);
          VungleListener listener = getVungleListener();
          VungleManager.getInstance().removeActiveBannerAd(mPlacementId);
          if (mPendingRequestBanner && listener != null) {
  ...
  private PlayAdCallback mAdPlayCallback =
      new PlayAdCallback() {
        ...
        public void onError(String placementId, VungleException exception) {
          Log.d(TAG, "Ad play failed:" + VungleBannerRequest.this);
          VungleListener listener = getVungleListener();
          VungleManager.getInstance().removeActiveBannerAd(mPlacementId);
          if (mPendingRequestBanner && listener != null) {
